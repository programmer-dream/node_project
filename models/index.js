...
db.IncomeHead = require("./IncomeHead.js")(sequelize, Sequelize);
db.InvoiceDetail = require("./InvoiceDetail.js")(sequelize, Sequelize);
...
db.TeacherAttendance.belongsTo(db.Employee,{foreignKey:'teacher_id',as:'teacher'})
/*********** query management ***********/
